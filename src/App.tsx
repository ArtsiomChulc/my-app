...
export type FilterValuesType = "all" | "active" | "completed" | "delall" | "threetasks";
// export type valueAllDelType = "delall";
...
// 2. Создадим четвертую кнопку фильтра — если ее нажать, то отобразятся первые три задачи
